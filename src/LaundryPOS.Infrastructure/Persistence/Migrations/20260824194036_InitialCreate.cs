        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "MXN"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProtocolType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ConnectionString = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    MqttTopic = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    LastHeartbeat = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastCommandSent = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastCommandResult = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IoTControllers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IoTControllers_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountFixedAmount = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ApplicableDays = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ApplicableHoursStart = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ApplicableHoursEnd = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastHeartbeat = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BranchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IoTControllerId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Machines_IoTControllers_IoTControllerId",
                        column: x => x.IoTControllerId,
                        principalTable: "IoTControllers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MachineAlerts_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MachineAlerts_Machines_MachineId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoursWorkedAtService = table.Column<double>(type: "float", nullable: false),
                    CyclesAtService = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceRecords_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MaintenanceRecords_Users_TechnicianId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorizationNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IoTControllers_BranchId",
                table: "IoTControllers",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_MachineAlerts_BranchId_IsResolved",
                table: "MachineAlerts",
                columns: new[] { "BranchId", "IsResolved" });

            migrationBuilder.CreateIndex(
                name: "IX_MachineAlerts_MachineId",
                table: "MachineAlerts",
                column: "MachineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Machines_IoTControllerId",
                table: "Machines",
                column: "IoTControllerId");

            migrationBuilder.CreateIndex(
                name: "IX_Machines_Number_BranchId",
                table: "Machines",
                columns: new[] { "Number", "BranchId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRecords_BranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemSettings_Key_BranchId",
                table: "SystemSettings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_BranchId_TransactionDate",
                table: "Transactions",
                columns: new[] { "BranchId", "TransactionDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_MachineId_TransactionDate",
                table: "Transactions",
                columns: new[] { "MachineId", "TransactionDate" });
